...
Now, we can use principal component regression to better analyze the differentiating power of PCA. 
...
Now, we can inspect the average amounts of the top content categories for each cluster. 
...
#### **Results**
Looking at a two-key plot of the grocery baskets for each shopper, we can understand the spread of support, confidence, and lift:
