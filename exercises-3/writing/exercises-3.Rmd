...
```{r problem2, include=FALSE, message=FALSE}
...
##### Partial Dependence Plots 
```{r pdp1, echo=FALSE, message=FALSE}
plot(pdp_humidity)
plot(pdp_precip)
plot(pdp_temp)
```
...
```{r problem3, include=FALSE, message=FALSE}
...
```{r RMSE_1, echo=FALSE, message=FALSE}
CART_RMSE
RandomForest_RMSE
BoostedTree_RMSE
```
...
```{r pdp2, echo=FALSE, message=FALSE}
...
```{r problem4, include=FALSE, message=FALSE}
...
##### Out-of-Sample Performance Comparison
```{r problem4RMSE, echo=FALSE, message=FALSE}
CART_RMSE
RandomForest_RMSE
BoostedTree_RMSE
```
...
**Figure 1**
```{r p4_plot1, echo=FALSE, message=FALSE}
plot(plot1)
```
...
**Figure 2**
```{r p4_plot2, echo=FALSE, message=FALSE}
plot(plot2)
```
...
**Figure 3**
```{r p4_plot3, echo=FALSE, message=FALSE}
plot(plot3)
```
